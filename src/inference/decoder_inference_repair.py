...
if __name__ == "__main__":
    hf_home_path = "/home/causal-capacity/causality_grammar-DB41"
    output_base_path = "/home/causal-capacity/causality_grammar-DB41/results/inference_repair_depth0-50"
    # dataset_path = "/home/causal-capacity/causality_grammar-DB41/data/nl-depth12_test.parquet"
    dataset_path = "/home/causal-capacity/causality_grammar-DB41/data/alice_test_depth0-50_complete.parquet"
   

    # Put your finetuned checkpoint here. Can be a local path or a Hugging Face Hub ID.
    # Example HF model ID: "77/LogicBench-Qwen-FT-Response"
    finetuned_model_path = "LogicBench-Qwen-FT-Response"
    # Unsloth cache dir (keep your existing)
    cache_dir = "/home/causal-capacity/causality_grammar-DB41/models"
