...
if __name__ == "__main__":
    ...
    hf_home_path = str(project_root)
    output_base_path = str(project_root / "results" / "inference_standard_depth0-50")
    # Use the extended depth 0-50 test dataset
    dataset_path = str(project_root / "data" / "alice_test_depth0-50_complete.parquet")

    finetuned_model_path = "Logical_Reasoning_Qwen"
