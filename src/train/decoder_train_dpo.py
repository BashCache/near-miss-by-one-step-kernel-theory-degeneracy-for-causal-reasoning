...
if __name__ == "__main__":
    ...
    dataset_path = "/Users/Causal-Reasoning-Favors-Encoders-On-The-Limits-of-Decoder-Only-Models/causality_grammar-DB41/data/train_data_with_corruptions.parquet"
